...
class GuiSessionLogin(private val prevGui: GuiAltManager) : GuiScreen() {
    ...
    override fun initGui() {
        ...
        sessionTokenField = GuiTextField(666, Fonts.font20, width / 2 - 100, 80, 200, 20)
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        drawCenteredString(Fonts.font18, "Session Login", width / 2, 36, 0xffffff)
        drawCenteredString(Fonts.font18, status, width / 2, height / 4 + 80, 0xffffff)

        // Draw fields
        sessionTokenField.drawTextBox()

        drawCenteredString(Fonts.font20, "§7Session Token:", width / 2 - 65, 66, 0xffffff)
