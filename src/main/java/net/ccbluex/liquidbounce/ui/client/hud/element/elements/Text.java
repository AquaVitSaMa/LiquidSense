...
public class Text extends Element {
    ...
    private Value<Boolean> ping = new BoolValue("Ping",true).displayable(() ->
            rectMode.get().equals("Skeet") || rectMode.get().equals("NeverLose"));
    private Value<Boolean> ip = new BoolValue("IP",true).displayable(() ->
            rectMode.get().equals("Skeet") || rectMode.get().equals("NeverLose"));
    private Value<Boolean> tps = new BoolValue("TPS",true).displayable(() ->
            rectMode.get().equals("Skeet") || rectMode.get().equals("NeverLose"));
    private Value<Boolean> username = new BoolValue("Username",true).displayable(() ->
            rectMode.get().equals("Skeet") || rectMode.get().equals("NeverLose"));
