...
public class ScoreboardElement extends Element {
    ...
    public Border drawElement() {
        ...
        ScoreObjective objective = currObjective;
        if (currObjective == null) {
            objective = worldScoreboard.getObjectiveInDisplaySlot(1);
        }
        ...
        if (objective != null){
            ...
            List<Score> scores = scoreCollection.stream().filter(score -> {
            ...
            maxWidth = fontRenderer.getStringWidth(objective.getDisplayName());
            ...
            for (Score score : scoreCollection){
                ...
                if (index == scoreCollection.size() - 1) {
                    ...
                    fontRenderer.drawString(displayName, (float)(l1 + maxWidth / 2 - fontRenderer.getStringWidth(displayName) / 2), (float)(height -
                            fontRenderer.FONT_HEIGHT), textColor.getRGB(), shadowValue.get());
                }
                index++;
            }
        }
